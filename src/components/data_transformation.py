...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function transforms the data before it is used for training
        '''
        try:
            ...
            logging.info("Completed transforming categorical variables")

            logging.info("Completed transforming numerical variables")
